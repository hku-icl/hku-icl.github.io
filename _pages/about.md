...
<div style="font-family: 'Helvetica Neue', 'Segoe UI', Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 25px 20px; line-height: 1.6; color: #24292e;">

  <!-- 英文段落1 -->
  <div style="margin-bottom: 22px;">
    <p style="margin: 0; font-size: 16.5px; letter-spacing: 0.01em; color: #24292e; font-weight: 400;">
  ...
  <!-- 中文段落1 -->
  <div style="margin-bottom: 22px; font-family: 'PingFang SC', 'Microsoft YaHei', 'Hiragino Sans GB', 'WenQuanYi Micro Hei', sans-serif;">
    <p style="margin: 0; font-size: 16px; color: #2c3e50; line-height: 1.7; text-align: justify;">
      <!--无线通信是塑造人类文明的隐形脉搏。从古时的烽火传信到今天的万物智联，通信技术的每一次跃迁都深刻改变了社会协作与知识流动的方式。香农的信息论奠定了数字时代的基石，而数十年来无线通信的演进史，正是一部人类不断突破时空限制、追求更高效连接的文明进化史。它不仅是技术基础设施，更是承载全球对话、驱动科学发现与产业革命的无形引擎。-->
    </p>
  </div>
  ...
  <div style="margin-bottom: 22px; font-family: 'PingFang SC', 'Microsoft YaHei', 'Hiragino Sans GB', 'WenQuanYi Micro Hei', sans-serif;">
    <p style="margin: 0; font-size: 16px; color: #2c3e50; line-height: 1.7; text-align: justify;">
      <!--在智能通信实验室，我们追随通信先驱的智慧足迹，站在巨人的肩膀上仰望下一个通信范式。我们相信，真正革命性的突破源于对通信基础原理的深刻理解与再想象。我们的使命是重新定义无线系统的极限，将其打造得更智能、更高效、更可靠，从而为上层飞速进化的数字世界提供无可撼动的基石。-->
    </p>
  </div>

  <!-- 最后一句英文（特殊样式） -->
  <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #eaeaea;">
    <p style="margin: 0; font-size: 17px; color: #0366d6; font-weight: 500; letter-spacing: 0.02em; text-align: center; font-family: 'Helvetica Neue', 'Segoe UI', Arial, sans-serif;">
...
<div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: white; border: 1px solid #e1e4e8; border-radius: 10px; padding: 20px; box-shadow: 0 3px 12px rgba(0,0,0,0.05); margin-bottom: 20px;">
    ...
    <div style="text-align: center; border-top: 1px solid #f1f1f1; padding-top: 15px;">
      <img src="/images/ICC2023.png" alt="ICC Best Paper Award" style="width: 400px; height: 300px; object-fit: contain; border-radius: 6px; margin: 0 auto;">
    </div>
  </div>
  ...
  <div style="background: white; border: 1px solid #e1e4e8; border-radius: 10px; padding: 20px; box-shadow: 0 3px 12px rgba(0,0,0,0.05); margin-bottom: 20px;">
    ...
    <div style="text-align: center; border-top: 1px solid #f1f1f1; padding-top: 15px;">
      <img src="/images/CIE2024.png" alt="CIE Best Poster Award" style="width: 400px; height: 300px; object-fit: contain; border-radius: 6px; margin: 0 auto;">
    </div>
  </div>
